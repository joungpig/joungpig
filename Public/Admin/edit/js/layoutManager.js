...
//			defaultValue='';
	...
	this.editField=function(event,e,id){
		...
		//类型为图片
				...
				var textEle=$($.parseHTML('<input id="pid" type="hidden" value="'+table+'"><img  id="img" onclick="upload(1)" src="'+value+'" width="188px" height="124px">'));
				div_.append(textEle);
		}
		//类型为文章
