...
class WechatAuth {
    ...
    public function getCallBackIp(){
        ...
        $info = self::http("{$this->apiURL}/getcallbackip", $query);
    ...
    public function getMaterialcount(){
        ...
        $info = self::http("{$this->apiURL}/material/get_materialcount", $query);
        return json_decode($info, true);
    }
    ...
    public function tagCreate($data){
        return $this->api('tags/create', $data);
    }
     ...
     * @Date 2018/2/13
     */
    public function userTag($data){
        return $this->api('tags/members/batchtagging', $data);
    }
    ...
    public function getUserTag($data){
        return $this->api('tags/getidlist', $data);
    }
     ...
     * @Date 2018/2/13
     */
    public function userRemark($data){
        return $this->api('user/info/updateremark', $data);
    }
