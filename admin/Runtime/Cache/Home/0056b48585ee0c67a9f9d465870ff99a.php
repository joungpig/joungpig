                  ...
                  <div class="widget-content">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td><?php echo ($vo["columuid"]); ?></td>
                          <td><?php echo ($vo["good"]); ?></td>
                          <td><?php echo ($vo["view"]); ?></td>
                          <td><?php echo ($vo["time"]); ?></td>
                          <td><?php echo ($vo["tag2"]); ?></td>
                          <td><?php echo ($vo["tag1"]); ?></td>
                          <td>
                          ...
                          <td>
                              ...
                              <a  href="<?php echo U('article/put', array('id'=>$vo['id']));?>"  class="btn btn-xs btn-success"><i class="icon-ok"></i> </a>
                              <a  href="<?php echo U('article/down', array('id'=>$vo['id']));?>" class="btn btn-xs btn-info"><i class="icon-arrow-down"></i> </a>
                              <a  href="<?php echo U('article/del', array('id'=>$vo['id']));?>"  class="btn btn-xs btn-danger"><i class="icon-remove"></i> </a>
                              <a  href="<?php echo U('article/edit', array('id'=>$vo['id']));?>" class="btn btn-xs btn-warning"><i class="icon-pencil"></i> </a>
