                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td>
                              ...
                              <a  href="<?php echo U('start/put', array('id'=>$vo['id']));?>"  class="btn btn-xs btn-success"><i class="icon-ok"></i> </a>
                              <a  href="<?php echo U('start/down', array('id'=>$vo['id']));?>" class="btn btn-xs btn-info"><i class="icon-arrow-down"></i> </a>
                              <a  href="<?php echo U('start/del', array('id'=>$vo['id']));?>"  class="btn btn-xs btn-danger"><i class="icon-remove"></i> </a>
                              <a  href="<?php echo U('start/edit', array('id'=>$vo['id']));?>" class="btn btn-xs btn-warning"><i class="icon-pencil"></i> </a>
