        ...
        <div class="col-xs-12 col-form"  style="min-height:300px;padding-right:0;padding-left:0;">
            ...
            <div class="form-horizontal" id="1482240675094" style="clear:both;display:block">
                <div class="form-group">
                    ...
                    <div class="col-xs-4" compute="false"  canupdate="true" type="text" name="name" rows="3" label="栏目名称" table="columu" value="<?php echo ($columu_info['name']); ?>"  edit_url="<?php echo U('columu/edit');?>">
                        <p style="color:#707070;font-family:微软雅黑;font-size: 13px;" class="form-control-static" onclick="LM.editField(event,$(this))"><?php echo ($columu_info['name']); ?></p>
                    </div>
                    <label class="control-label col-xs-2">
                        栏目类型
                    </label>
                    <div class="col-xs-4" compute="false"  canupdate="true" type="picklist" name="type" rows="3" label="栏目类型" table="source" value="<?php echo ($columu_info['type']); ?>"  edit_url="<?php echo U('columu/edit');?>" get_url="<?php echo U('columu/edit');?>" >

                        <p id="type" style="color:#707070;font-family:微软雅黑;font-size: 13px;" class="form-control-static" onclick="LM.editField(event,$(this))"></p>
                </div>
            </div>
                <div class="form-group">
                    <label class="control-label col-xs-2">
                    ...
                    <div class="col-xs-4" compute="false"  canupdate="true" type="picklist" name="state" rows="3" label="栏目状态" table="source" value="<?php echo ($columu_info['state']); ?>"  edit_url="<?php echo U('columu/edit');?>" get_url="<?php echo U('columu/edit');?>">
