        ...
        <div class="col-xs-12 col-form"  style="min-height:300px;padding-right:0;padding-left:0;">
            ...
            <div class="form-horizontal" id="1482240675094" style="clear:both;display:block">
                <div class="form-group">
                    ...
                    <div class="col-xs-4" compute="false"  canupdate="true" type="picklist" name="state" rows="3" label="栏目状态" table="source" value="<?php echo ($user_info['state']); ?>"  edit_url="<?php echo U('user/edit');?>" get_url="<?php echo U('user/edit');?>">

                        <p id="state" style="color:#707070;font-family:微软雅黑;font-size: 13px;" class="form-control-static" onclick="LM.editField(event,$(this))"><?php echo ($user_info['state']); ?></p>
                    </div>
                    <!--<label class="control-label col-xs-2">-->
                    <!--客户名称-->
                    <!--</label>-->
...
<script type="text/javascript">
    $(document).ready(function() {
        var state = "<?php echo ($user_info["state"]); ?>"
        if(state==0){
            $("#state").text('禁用');
        }else if(state==1){
            $("#state").text('启用');
