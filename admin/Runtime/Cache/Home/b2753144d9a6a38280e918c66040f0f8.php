                  ...
                  <div class="widget-content">
                    ...
                    <table class="table table-striped table-bordered table-hover">
                      ...
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                          ...
                          <td>
                              <a  href="<?php echo U('fuli/put', array('id'=>$vo['id']));?>"  class="btn btn-xs btn-success"><i class="icon-ok"></i> </a>
                              <a  href="<?php echo U('fuli/down', array('id'=>$vo['id']));?>" class="btn btn-xs btn-info"><i class="icon-arrow-down"></i> </a>
      ...
      <div class="modal-body">
        <form role="form" id="add">
          <div class="form-group">
            <label >福利名称</label>
            <input type="text" class="form-control" name="fuliname" placeholder="请输入名称" required>
          </div>
          <div class="form-group">
            <label >磁力</label>
            <input type="text" class="form-control" name="content" placeholder="请输入名称" required>
          </div>
        </form>
      </div>
